<x-app-layout>
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-800 dark:bg-gray-900">
        <div class="flex justify-between w-full sm:max-w-xl">
            ...
            <div>
                <a href="{{ route('tickets.create') }}" class="bg-white rounded-lg p-2">Create New</a>
            </div>
        </div>
        <div
            class="w-full sm:max-w-xl mt-6 px-6 py-4 bg-slate-900 dark:bg-gray-800 shadow-md overflow-hidden sm:rounded-lg">
